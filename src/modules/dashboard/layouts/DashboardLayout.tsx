...
import { ProntuarioFloatProvider } from '../../../contexts/ProntuarioFloatContext';
import { ProntuarioFloatWindow } from '../components/ProntuarioFloatWindow';

export function DashboardLayout() {
  const [isSidebarOpen, setIsSidebarOpen] = useState(false);

  return (
    <ProntuarioFloatProvider>
