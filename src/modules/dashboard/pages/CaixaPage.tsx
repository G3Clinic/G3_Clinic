...
import { Landmark, ArrowUpCircle, ArrowDownCircle, Lock, DollarSign, Wallet, Unlock, Clock, TrendingUp } from 'lucide-react';
...
export function CaixaPage() {
  ...
  return (
    <div className="space-y-6 print:space-y-4">
      ...
      {/* Status do turno de caixa (apenas para quem não é profissional) */}
      {!isProfissional && (
      ...
      {filtroProf && (
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 p-4 rounded-xl flex items-center justify-between shadow-sm">
          <div>
