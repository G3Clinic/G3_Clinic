...
export function ResetPasswordPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center bg-[#F2F4F8] p-4 font-sans relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white p-10 rounded-[2rem] shadow-xl border border-gray-100">
          ...
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-ui-text mb-2">Redefinir Senha</h1>
            <p className="text-ui-muted text-sm">Crie uma nova credencial segura para retomar o acesso.</p>
          </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-ui-muted opacity-60">
            &copy; 2026 Avda Software &bull; Segurança Ativa
          </p>
        </div>
