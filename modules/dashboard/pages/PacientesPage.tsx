        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 pb-32">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <InputField label="CPF *" required placeholder="000.000.000-00" mask="cpf" defaultValue={perfilAtivo ? perfilAtivo.cpf : ''} />
              <InputField label="Celular / WhatsApp *" required placeholder="(00) 00000-0000" mask="phone" defaultValue={perfilAtivo ? perfilAtivo.tel : ''} />
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <InputField label="CPF do Responsável" placeholder="000.000.000-00" mask="cpf" />
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <InputField 
                ...
                mask="cep" 
                onCepFetched={(data) => {
                  const logradouro = document.getElementById('pac-logradouro') as HTMLInputElement;
                  const bairro = document.getElementById('pac-bairro') as HTMLInputElement;
                  const cidade = document.getElementById('pac-cidade') as HTMLInputElement;
                  const uf = document.getElementById('pac-uf') as HTMLSelectElement;
              ...
              />
              <InputField id="pac-logradouro" label="Logradouro" placeholder="Rua, Avenida..." className="col-span-2" defaultValue={perfilAtivo ? 'Rua das Flores' : ''} />
              ...
              <InputField id="pac-bairro" label="Bairro" placeholder="Bairro" defaultValue={perfilAtivo ? 'Centro' : ''} />
              <InputField id="pac-cidade" label="Cidade" placeholder="Cidade" defaultValue={perfilAtivo ? 'São Paulo' : ''} />
              <SelectField id="pac-uf" label="UF">
                <option value="">UF</option>
                <option value="SP" selected={!!perfilAtivo}>SP</option>
